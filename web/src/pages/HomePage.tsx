...
export function HomePage() {
  ...
  return (
    <div className="max-w-md mx-auto bg-[#fff7f0] min-h-screen pb-20">
      ...
      {/* 2. LIVE STATS BAR — real numbers from the project dataset */}
      <div className="mx-4 mt-6 grid grid-cols-3 gap-3">
        {[
          {
            label: "Ongoing Projects",
            value: String(enhancedProjects.filter((p) => p.status === 'ongoing').length),
            icon: "🏗️",
          },
          {
            label: "Completed",
          ...
          { label: "Tracked Total", value: String(enhancedProjects.length), icon: "📍" }
        ].map((stat, i) => (
